		            ...
		            <div class="mb-md-5 mt-md-4 pb-5">
		              ...
		              <?php foreach ($alldata as $value): ?>
		               <div class="form-outline form-white mb-4">
		                ...
		                <input type="hidden" id="typeEmailX" name="idMon" class="form-control form-control-lg" value="<?= $value['idMon'] ?>" />
		              ...
		              <div class="form-outline form-white mb-4">
		                ...
		                <input type="text" id="typeEmailX" name="tenMon" class="form-control form-control-lg" value="<?= $value['tenMon'] ?>" />
